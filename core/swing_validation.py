...
def _build_operational_consistency(
    ...
    return {
        ...
        "no_setup_decomposition_top_bucket": str(
            no_setup_eligible_decomposition.get("top_reason_bucket") or "INSUFFICIENT_DATA_FOR_DECOMPOSITION"
        ),
        "no_setup_decomposition_recommendation": str(
            no_setup_eligible_decomposition.get("recommendation") or "insufficient_data"
        ),
        "reversal_routing_mode": reversal_blocker_routing_audit.get("mode", "DIAGNOSTIC_ONLY"),
        "reversal_routing_top_symbol": str(reversal_blocker_routing_audit.get("top_symbol") or ""),
        "reversal_routing_top_status": str(
            reversal_blocker_routing_audit.get("top_route_status") or "INSUFFICIENT_DATA_FOR_ROUTING"
        ),
        ...
        "bos_confirmation_quality_mode": bos_confirmation_quality_audit.get("mode", "DIAGNOSTIC_ONLY"),
        "bos_confirmation_quality_top_symbol": str(bos_confirmation_quality_audit.get("top_symbol") or ""),
        "bos_confirmation_quality_status": str(
            bos_confirmation_quality_audit.get("bos_quality_status") or "INSUFFICIENT_DATA_FOR_BOS_QUALITY"
        ),
        ...
        "phase2_1_fine_tune_enabled": bool(phase2_1_fine_tune.get("phase2_1_fine_tune_enabled", False)),
        "phase2_1_fine_tune_target": str(phase2_1_fine_tune.get("phase2_1_fine_tune_target") or ""),
        "phase2_1_fine_tune_applied_count": int(phase2_1_fine_tune.get("phase2_1_fine_tune_applied_count", 0) or 0),
    }
    ...
    *,
    ...
    if isinstance(cycle_result, dict):
        ...
        state["no_setup_eligible_decomposition"] = dict(
            ...
            or (cycle_result.get("validation_cycle", {}) or {}).get("no_setup_eligible_decomposition", {})
            or state.get("no_setup_eligible_decomposition", {})
            or default_no_setup_eligible_decomposition_state()
        )
        state["reversal_blocker_routing_audit"] = dict(
            cycle_result.get("reversal_blocker_routing_audit")
        ...
        state["bos_confirmation_quality_audit"] = dict(
            cycle_result.get("bos_confirmation_quality_audit")
        ...
        state["phase2_1_fine_tune"] = dict(
            cycle_result.get("phase2_1_fine_tune")
            or (cycle_result.get("validation_cycle", {}) or {}).get("phase2_1_fine_tune", {})
    ...
    updated_state["no_setup_eligible_decomposition"] = dict(
        ...
        or updated_state.get("no_setup_eligible_decomposition", {})
        or default_no_setup_eligible_decomposition_state()
    )
    updated_state["reversal_blocker_routing_audit"] = dict(
    ...
    updated_state["bos_confirmation_quality_audit"] = dict(
    ...
    updated_state["phase2_1_fine_tune"] = dict(
        sanitized_report.get("phase2_1_fine_tune")
        or updated_state.get("phase2_1_fine_tune", {})
        or {}
    )
